...
export default function CreatePostPage() {
  ...
  const handleGenerateAi = async () => {
    ...
    try {
      ...
      toast.error(err.response?.data?.message || t('aiFailed'));
    } finally {
      setGenerating(false);
    }
  };
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <h2 className="text-lg font-semibold text-gray-900">{t('generateWithAi')}</h2>
            ...
            <CardBody>
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">{t('brandName')}</label>
                    <input
                      type="text"
          ...
          {aiGenerated && aiGenerated.variations.length > 0 && (
            <Card>
              <CardHeader>
                <h2 className="text-lg font-semibold text-gray-900">{t('aiVariations')}</h2>
              </CardHeader>
              <CardBody>
          ...
          <form onSubmit={handleSubmit}>
            <Card>
              <CardHeader>
                <h2 className="text-lg font-semibold text-gray-900">{t('postDetails')}</h2>
              </CardHeader>
              <CardBody>
                <div className="space-y-4">
                  <div>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">{t('hashtags')}</label>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      >
                        ...
                        <option value="both">{t('platforms.both')}</option>
                      </select>
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">
                  ...
                  <div>
                    ...
                    <div className="flex space-x-4">
                      <label className="inline-flex items-center">
                        ...
                        />
                        <span className="ml-2 text-sm text-gray-700">{t('postNow')}</span>
                      </label>
                      <label className="inline-flex items-center">
                        <input
                          type="radio"
                          ...
                          className="form-radio text-primary-600"
                        />
                        <span className="ml-2 text-sm text-gray-700">{t('schedule')}</span>
                      </label>
                      <label className="inline-flex items-center">
                        <input
                          type="radio"
                          ...
                          className="form-radio text-primary-600"
                        />
                        <span className="ml-2 text-sm text-gray-700">{t('saveAsDraft')}</span>
                      </label>
                    </div>
                  </div>
                  {publishMode === 'schedule' && (
